...
// Item 1: Swagger/OpenAPI. XML doc comments (UrlShortener.Api.csproj's
...
// UrlShortenerWebApplicationFactory swaps in its own connection/migration lifecycle
...
// src/db/urlshortener.db regardless of the working directory the app is launched from
...
string ResolveSqliteConnectionString()
{
    ...
    var dbPath = Path.Combine(dbDirectory, "urlshortener.db");
    return $"Data Source={dbPath}";
}

/// <summary>
/// Exposes the generated Program class publicly so UrlShortener.IntegrationTests can boot
