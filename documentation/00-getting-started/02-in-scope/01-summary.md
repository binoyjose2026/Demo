...
**Purpose:** Quick-reference summary of what is confirmed **in scope for v1**. Each item cites the requirement ID(s) and/or question number (Q#) it comes from. Companion to `../03-out-of-scope/01-summary.md`.
