...
Explain why Kafka is or is not a sutable solution for it. create a specific document on this comparison C:\BinoyJoseOfficial\InterviewDemo\UrlShortner\documentation\02-design\v2\design\considerations\05-kafka-comaporison.md - don't just default to "Kafka is the industry standard so use it," actually work through whether our numbers justify it or whether something simpler does the job just as well.
