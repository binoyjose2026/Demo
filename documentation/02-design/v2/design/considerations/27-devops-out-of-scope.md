...
**Traceability:** `agent-prompt.md` (review scope item: "Dev Ops: Create a document and say it is out of scope").

---

## 1. What Is Excluded, and Why

`agent-prompt.md` states its own scope explicitly: *"the review of a project like this can take a lot of questions and numerous days... I am limiting the scope of the review to one or two review items... Scope of the review: Scalability."*
...
Treat DevOps as its own separate, scoped review at a later time, consistent with `agent-prompt.md`'s own stated pattern of limiting each review pass to one or two items rather than expanding a single review indefinitely.
