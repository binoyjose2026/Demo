...
**Output folder:** `../..` (this `v0-received-as-is` folder)

**Create two documents:**
- `requirement.functional.v1.md`
- `requirement.non-functional.v1.md`

**Rules:**
- Do not assume or add anything
- Do not miss anything
- Do not mention the interview process
- Do not mention the client name — always use "client" (this project will go into a public repo)
